...
const { getAllUsers, getUserById, UpdateUserProfile, getAllProviders } = require('../controllers/User.controller');
...
UserRouter.get('/getAllProviders',authentication,authorization('admin'),getAllProviders);
